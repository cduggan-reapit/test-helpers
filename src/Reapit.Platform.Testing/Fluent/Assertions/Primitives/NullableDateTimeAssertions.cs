...
[DebuggerNonUserCode]
public class NullableDateTimeAssertions(DateTime? subject)
    : NullableDateTimeAssertions<NullableDateTimeAssertions>(subject);
...
public class NullableDateTimeAssertions<TAssertions>(DateTime? subject)
    : DateTimeAssertions<TAssertions>(subject)
