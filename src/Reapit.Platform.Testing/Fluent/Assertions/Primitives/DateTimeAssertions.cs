...
[DebuggerNonUserCode]
public class DateTimeAssertions(DateTime subject)
    : DateTimeAssertions<DateTimeAssertions>(subject);
    ...
    where TAssertions : DateTimeAssertions<TAssertions>
{
    ...
    protected DateTime? Subject { get; }
    
    /// <summary>Initializes a new instance of the <see cref="DateTimeAssertions"/> class.</summary>
    /// <param name="subject">The nullable assertion subject.</param>
    protected DateTimeAssertions(DateTime? subject)
        => Subject = subject;
    
    /// <summary>Initializes a new instance of the <see cref="DateTimeAssertions"/> class.</summary>
    /// <param name="subject">The assertion subject.</param>
    protected DateTimeAssertions(DateTime subject) : this((DateTime?)subject)
    {
    }
